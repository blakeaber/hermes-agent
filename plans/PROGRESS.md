...
|------|-------|--------|-----------|
| 001 | Multi-User SaaS Hermes — Identity, Scoped Skills & Memory, Cloud Storage | DRAFT (2026-05-18) — 6 phases (0, A, B, C, D, E). Lives in `plans/001-saas-multi-user/phases/` (format-corrected 2026-05-18). Blocks Plans 002 + 003. | — |
...
- **001 — Multi-User SaaS** (2026-05-18): Phase 0 (Identity & HermesIdentity) is the critical path. All other phases depend on it. Lives in `plans/001-saas-multi-user/phases/` (format-corrected 2026-05-18).
